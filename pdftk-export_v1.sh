...
# Исходный файл для экспорта
file_name=test.pdf

# Новое имя для всех файлов
new_file_name="${file_name%.*}"

# Даты у нужном формате
...
# Вытаскиваем каждую страницу из ПДФ. Задаем ей имя в конце с датой из массива сверху

for value in {1..366}; do
	pdftk "$file_name" cat $i output $new_file_name-${name_array[i-1]}.pdf
	let i=i+1
done